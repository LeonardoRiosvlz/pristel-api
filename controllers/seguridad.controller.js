...
exports.findAll = async (req, res) => {
    const id =req.body.id;
    await  Seguridad.findAndCountAll({
        limit: 3000000,
        offset: 0,
        where: { }, // conditions
        order: [
